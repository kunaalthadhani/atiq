              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                {editingUnit && !isNewUnit && (
                  <div>
                    ...
                    <div className={`w-full px-3 py-1.5 text-sm border border-gray-200 rounded-lg bg-gray-50 ${editingUnit.isOccupied ? 'text-red-600' : 'text-green-600'} font-medium`}>
                      {editingUnit.isOccupied ? 'Occupied' : 'Vacant'}
                    </div>
                    <p className="text-xs text-gray-500 mt-1">Status is managed automatically by contracts</p>
                  </div>
                )}
              </div>
