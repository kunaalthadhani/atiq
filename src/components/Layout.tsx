...
export default function Layout() {
  ...
  const dismissApprovalNotification = (id: string) => {
    setDismissedApprovalIds(prev => new Set(prev).add(id));
  };

  const visibleApprovals = pendingApprovals.filter(a => !dismissedApprovalIds.has(a.id));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pl-64">
        ...
        <div className="fixed top-4 right-4 z-50 w-96 max-h-[80vh] overflow-y-auto space-y-2">
          ...
          {isAdmin && visibleApprovals.length > 0 && (
            <>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-shrink-0 flex items-center gap-2">
                      ...
                      <button
                        onClick={() => dismissApprovalNotification(approval.id)}
                        className="text-yellow-600 hover:text-yellow-900"
